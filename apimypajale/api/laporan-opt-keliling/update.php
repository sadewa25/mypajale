<?php
  ...
  if (!empty($id_user) &&
    ...
    if ($laporan->update()) {
      ...
      echo json_encode(array("value" => 1, "message" => "Laporan berhasil diperbarui"));

    } else {
      http_response_code(503);
      echo json_encode(array("value" => 0, "message" => "Gagal memperbarui laporan"));

    }

  } else {
    http_response_code(400);
    echo json_encode(array("value" => 0, "message" => "Gagal memperbarui laporan. Data tidak lengkap"));
