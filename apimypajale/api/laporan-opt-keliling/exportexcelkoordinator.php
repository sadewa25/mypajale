<?php
  ...
  header("Content-Disposition: attachment; filename=Data-Laporan-Keliling-Koordinator-Bulan-$bulan-Tahun-$year.xls");
      ...
      <tbody>
        <?php
          if (!empty($id_koordinator)) {
            $laporan->id_koordinator = $id_koordinator;

            $stmt = $laporan->exportExcelKoordinator();
