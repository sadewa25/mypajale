<?php
  ...
  if (!empty($judul_tips) &&
    ...
    if ($tips->insert()) {
      ...
      echo json_encode(array("value" => 1, "message" => "tips berhasil ditambahkan"));

    } else {
      http_response_code(503);
      echo json_encode(array("value" => 0, "message" => "Gagal menambahkan tips"));

    }

  } else {
    http_response_code(400);
    echo json_encode(array("value" => 0, "message" => "Gagal menambahkan tips. Data tidak lengkap"));
