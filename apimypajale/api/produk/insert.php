<?php
  ...
  if (!empty($nama_produk) &&
    ...
    if ($produk->insert()) {
      ...
      echo json_encode(array("value" => 1, "message" => "produk berhasil ditambahkan"));

    } else {
      http_response_code(503);
      echo json_encode(array("value" => 0, "message" => "Gagal menambahkan produk"));

    }

  } else {
    http_response_code(400);
    echo json_encode(array("value" => 0, "message" => "Gagal menambahkan produk. Data tidak lengkap"));
