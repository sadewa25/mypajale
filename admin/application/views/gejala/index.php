      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header bg-success">
            <h5 class="modal-title" id="modal-add-title">Tambah Gejala</h5>
          ...
          <div class="modal-body">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                <label for="organ-terserang-add">Organ Terserang</label>
                <select class="form-control" id="organ-terserang-add">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header bg-warning">
            <h5 class="modal-title" id="modal-edit-title">Edit Gejala</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <input type="hidden" class="form-control" id="id-gejala-edit" value="">
            <div class="form-group">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                <label for="organ-terserang-add">Organ Terserang</label>
                <select class="form-control" id="organ-terserang-edit">
                  <option value="">Pilih Organ</option>
                </select>
              </div>
              <div class="form-group col-md-6">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="delete-modal">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <input type="hidden" class="form-control" id="id-gejala-delete" value="">
...
<script src="<?php echo base_url().'assets/js/pages/gejala.js'?>"></script>
